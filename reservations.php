                    ...
                    <tbody>
                        <?php foreach ($recentReservations as $r): ?>
                            <tr>
                                ...
                                <?php $sourceTag = strtolower((string) (($r['booking_channel'] ?? '') ?: ($r['source'] ?? 'manual'))); ?>
                                <td><span class="source-tag source-<?= htmlspecialchars($sourceTag, ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars(strtoupper($sourceTag), ENT_QUOTES, 'UTF-8') ?></span></td>
